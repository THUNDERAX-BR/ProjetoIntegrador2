 ...
 * @author Gato Sagrado
 */
public class TelaGerenciarCategorias extends javax.swing.JPanel implements GlobalListener {
    ...
    private void initComponents() {
        ...
        TxBusca.setToolTipText("Digite o ID ou nome da categoria");
        ...
        LbTutorial4.setDisplayedMnemonic('i');
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobreporPainel(new TelaCadastroSimples(this, -1, 'c'));
    ...
    private void listar() {
        ...
        List<Categorias> lista = categoriasDao.listarGerenciar(busca);
        if (lista != null) {
            if (lista.isEmpty()) {
            ...
            for (int i = 0; i < lista.size(); i++) {
                PnCategoriaGerenciar painel = new PnCategoriaGerenciar(lista.get(i));
