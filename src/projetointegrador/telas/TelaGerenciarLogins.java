 ...
 * @author Gato Sagrado
 */
public class TelaGerenciarLogins extends javax.swing.JPanel implements GlobalListener {

    /**
     * Creates new form GerenciarLogins
     */
    ...
    private void initComponents() {
        ...
        BtBusca.setToolTipText("Busca o ID ou login");
        ...
        TxBusca.setText("Buscar por ID ou login");
        TxBusca.setToolTipText("Digite o ID ou login");
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobreporPainel(new TelaCadastroLogin(this));
    ...
    private void listar() {
        try {
            ...
            List<Logins> lista = loginDao.listarGerenciar(busca);
            if (lista != null) {
                if (lista.isEmpty()) {
                ...
                for (int i = 0; i < lista.size(); i++) {
                    PnLoginGerenciar panel = new PnLoginGerenciar(lista.get(i));
