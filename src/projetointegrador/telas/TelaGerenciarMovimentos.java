 ...
 * @author Gato Sagrado
 */
public class TelaGerenciarMovimentos extends javax.swing.JPanel implements GlobalListener {

    /**
     * Creates new form GerenciarMovimentos
     */
    public TelaGerenciarMovimentos() {
        initComponents();
        listar();
    }
    ...
    private void initComponents() {
        ...
        TxBusca.setToolTipText("Digite o ID ou nome do movimento");
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobreporPainel(new TelaCadastroSimples(this, -1, 'm'));
    }//GEN-LAST:event_BtCadastroActionPerformed

    private void BtFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtFecharActionPerformed
        TelaPrincipal.trocarPainel(new TelaGerenciar());
    ...
    private void listar() {
        try {
            ...
            List<Movimentos> lista = movimentosDao.listarGerenciar(busca);
            if (lista != null) {
                if (lista.isEmpty()) {
                ...
                for (int i = 0; i < lista.size(); i++) {
                    PnMovimentoGerenciar painel = new PnMovimentoGerenciar(lista.get(i));
