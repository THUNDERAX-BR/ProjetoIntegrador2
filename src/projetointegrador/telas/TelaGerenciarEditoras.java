 ...
 * @author Gato Sagrado
 */
public class TelaGerenciarEditoras extends javax.swing.JPanel implements GlobalListener {

    /**
     * Creates new form GerenciarEditoras
     */
    public TelaGerenciarEditoras() {
        initComponents();
        listar();
    }
    ...
    private void initComponents() {
        ...
        TxBusca.setToolTipText("Digite o ID ou nome da editora");
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobreporPainel(new TelaCadastroSimples(this, -1, 'e'));
