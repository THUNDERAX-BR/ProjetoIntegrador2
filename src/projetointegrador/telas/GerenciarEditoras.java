 ...
 * @author Gato Sagrado
 */
public class GerenciarEditoras extends javax.swing.JPanel implements GlobalListener {

    /**
     * Creates new form GerenciarEditoras
     */
    public GerenciarEditoras() {
        initComponents();
        listar();
    }
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobreporPainel(new CadastroSimples(this, -1, 'e'));
