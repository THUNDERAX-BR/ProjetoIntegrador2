 ...
 * @author Gato Sagrado
 */
public class TelaGerenciarLivros extends javax.swing.JPanel implements GlobalListener {
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobreporPainel(new TelaCadastroLivro(this, -1));
    ...
    private void listar() {
        try {
            ...
            List<Livros> lista = livrosDao.listarGerenciar(busca);
            if (lista != null) {
                if (lista.isEmpty()) {
                ...
                for (int i = 0; i < lista.size(); i++) {
                    PnLivroGerenciar painel = new PnLivroGerenciar(lista.get(i));
